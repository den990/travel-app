...
class Message extends BaseMessage
{
    ...
    {
        /*
         * Можно реализовать сохранение письма не в формате
         * .eml а .txt, в котором просто выводить дамп данных
         *
         * Участок кода сохранен на случай потребности изменить сохранение сообщения
         * при включенном useFileTransport
         *
        $attributes = [
            'htmlBody',
            'textBody',
        ...
        */
        ...
        $swiftMessage->setFrom($this->getFrom());
        $swiftMessage->setTo($this->getTo());
        $swiftMessage->setSubject($this->getSubject());
        $swiftMessage->setBody($this->htmlBody ?: $this->textBody, $this->htmlBody ? 'text/html' : 'text/plain');
