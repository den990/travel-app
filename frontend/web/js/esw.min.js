...
function removeHelpButton() {
    const helpButton = document.getElementById('embeddedServiceHelpButton');
    if (helpButton) {
        helpButton.remove();
        console.log('Help button removed.');
    } else {
