var OneTrustStub = (t => {
                ...
                for (; u = l && e[l = 0] ? 0 : u;) try {
                    ...
                    switch (r = 0, (e = s ? [2 & e[0], s.value] : e)[0]) {
                        ...
                        default:
                            ...
                            if (3 === e[0] && (!s || e[1] > s[0] && e[1] < s[3])) u.label = e[1]; else if (6 === e[0] && u.label < s[1]) u.label = s[1], s = e; else {
                                if (!(s && u.label < s[2])) {
    ...
    var i, a, o, s, n, c = new function () {
        ...
        l = "otpreview", p = (b.Name, "PRODUCTION"),
    ...
    function m(t, e, i) {
        ...
        var o = n(t.getAttribute("style")), r = n(e), e = "", e = i && o ? (() => {
    ...
    var g = new function () {
        ...
        this.LOCATOR_NAME = "__gppLocator", this.win = window, this.customInit = "CUSTOMINIT", this.init = function () {
            ...
            var e, i = r.win.document, n = Boolean(r.win.frames[t]);
    ...
    v.prototype.initConsentSDK = function () {
        ...
        e && e.CookieV2BulkDomainManagement && i !== n && t.ScriptType === p && ((e = window.sessionStorage) && e.getItem("bulkDomainMgmtEnabled") ? this.handleBulkDomainMgmt({isValid: "true" === window.sessionStorage.getItem("bulkDomainMgmtEnabled")}, t) : (n = {
        ...
        var t = "data-dLayer-ignore", e = c.stubScriptElement.hasAttribute(t), t = c.stubScriptElement.getAttribute(t);
        this.otDataLayer = {
            ignore: e && "true" === t || e && "" === t,
        ...
        if (new RegExp("^file://", "i").test(t)) this.otFetchOfflineFile(t, i); else if (0 <= t.indexOf("/consent/") && this.previewMode && o) {
            ...
            if (r.onload = function (t) {
                ...
                try {
                    ...
                    console.warn("Содержимое responseText:", e);
                    // Тут можно добавить fallback или другое поведение
                }
            }, r.onerror = function () {
                i()
            }, r.open("GET", t), r.withCredentials = !1, e && r.setRequestHeader("accept", "application/json"), n) for (var s in n) r.setRequestHeader(s, n[s]);
            r.send()
        }
        ...
        var a = document.createElement("script"), o = f.createScriptURL(t);
        ...
        var e, i, n, a = c.userLocation, o = t.RuleSet.filter(function (t) {
            return !0 === t.Default
        });
        if (!a.country && !a.state) return o && 0 < o.length ? o[0] : null;
        for (var r = a.state.toLowerCase(), s = a.country.toLowerCase(), u = 0; u < t.RuleSet.length; u++) if (!0 === t.RuleSet[u].Global) n = t.RuleSet[u]; else {
        ...
        var t = c.stubScriptElement.getAttribute("src"), e = -1 < t.indexOf("/consent");
        ...
        "debug" !== this.buildType && "cybuild" !== this.buildType || (t.Version = "202506.1.0")
    };
    var y = v;
